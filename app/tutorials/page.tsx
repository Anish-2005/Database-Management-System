        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-slate-400">Learn • Practice • Master</div>
            </div>
          </motion.div>
            ...
            {[
              ...
              <motion.a
                ...
                className={`text-sm font-medium transition-colors relative group ${
                  item.name === "Tutorials" ? "text-white" : "text-slate-300 hover:text-white"
                }`}
                whileHover={{ y: -2 }}
              >
                {item.name}
                <motion.div
                  ...
                  layoutId={item.name === "Tutorials" ? "navIndicator" : undefined}
                />
              </motion.a>
            ))}
          </div>
