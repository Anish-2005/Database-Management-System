...
import { PASSCODE } from '../../lib/labsData'
          ...
          <div className="p-6">
            ...
            <div className="mt-6 p-3 bg-slate-800/40 rounded-xl border border-slate-700">
              <p className="text-xs text-slate-500 text-center">
                <strong>Hint:</strong> The passcode is a common phrase used for access control.
                Think about what you might say to gain entry to a restricted area.
              </p>
            </div>
          </div>
        </motion.div>
