  ...
  return (
    ...
    >
      ...
      <p className="text-xl text-slate-400 max-w-3xl mx-auto leading-relaxed">
        Dive deep into practical database scenarios with our comprehensive lab environment.
        Build real-world skills through guided exercises and complex database challenges.
      </p>
    </motion.div>
  )
}